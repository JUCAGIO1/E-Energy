...
| :--- | :--- | :--- |
| **Giovanni Correa Amadio** | Líder do Projeto & Desenvolvedor Full Stack (Frontend & Backend) | • Concepção e arquitetura geral do ecossistema E-Energy<br>• **Backend:** Criação da API REST Express, modelagem MongoDB Atlas e segurança Zero Trust (HMAC, eFuse, RateLimit)<br>• **Frontend:** Arquitetura do app React Native, integração com API Axios e gerador de relatórios em PDF<br>• Liderança técnica e integração entre hardware e software |
...
| **Lucas Mickael** | Desenvolvedor Frontend & Responsável por Documentação Técnica | • **Frontend:** Desenvolvimento de telas e interfaces de usuário no aplicativo React Native/Expo<br>• Estilização visual, responsividade e componentes reutilizáveis da Landing Page Web<br>• **Documentação Técnica:** Elaboração dos manuais de arquitetura, guias de usuário e relatórios do projeto<br>• Estruturação de diagramas de fluxo e conformidade com as diretrizes acadêmicas da disciplina |
